...
// don't need to import generateMovieHTML from movie-converter.js here because that function isn't being called in this module. parameters are just placeholders so they don't need to be imported when only defining a function like i am here. only need to import functions, variables, data when using them directly(e.g., calling a function, looping over data, logging a value, etc.) 
